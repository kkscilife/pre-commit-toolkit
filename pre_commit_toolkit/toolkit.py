...
def main():
    parser = argparse.ArgumentParser(
        description="configure .pre-commit-config.yaml automaticlly",
    ...
    parser.add_argument(
        ...
        type=str,
        default='./',
        help='Specify a Git repository root directory path'
    )
    parser.add_argument(
        '--type',
        type=str,
    ...
    parser.add_argument(
        '--check',
        action='store_true',
        help='check local .pre-commit-config.yaml missing rules'
    )
